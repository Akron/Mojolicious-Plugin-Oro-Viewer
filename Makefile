...
#     ABSTRACT => q[View Oro Tables in your Application]
...
#     PREREQ_PM => { Test::More=>q[0], Mojolicious::Plugin::Oro=>q[0.05], Mojolicious::Plugin::TagHelpers::Pagination=>q[0.01], Mojolicious=>q[3.43], DBIx::Oro=>q[0.29] }
...
NAME_SYM = Mojolicious_Plugin_Oro_Viewer
VERSION = 0.01
...
MAKE = make
FULLEXT = Mojolicious/Plugin/Oro/Viewer
BASEEXT = Viewer
PARENT_NAME = Mojolicious::Plugin::Oro
DLBASE = $(BASEEXT)
...
INST_LIBDIR      = $(INST_LIB)/Mojolicious/Plugin/Oro
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Mojolicious/Plugin/Oro
...
TO_INST_PM = lib/Mojolicious/Plugin/Oro/Viewer.pm

PM_TO_BLIB = lib/Mojolicious/Plugin/Oro/Viewer.pm \
	blib/lib/Mojolicious/Plugin/Oro/Viewer.pm
...
DISTNAME = Mojolicious-Plugin-Oro-Viewer
DISTVNAME = Mojolicious-Plugin-Oro-Viewer-0.01
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''View Oro Tables in your Application'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Mojolicious-Plugin-Oro-Viewer' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  DBIx::Oro: 0.29' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "View Oro Tables in your Application",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Mojolicious-Plugin-Oro-Viewer",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "DBIx::Oro" : "0.29",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="DBIx::Oro" VERSION="0.29" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Mojolicious/Plugin/Oro/Viewer.pm blib/lib/Mojolicious/Plugin/Oro/Viewer.pm 
